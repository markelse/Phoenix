...
// Error Messages
// User errors
$errNoUser = "<span class='error'>Incorrect username or password entered, try again or <a href='index.php?page=register'>register a new account</a>.</span><br />";
...
// Password errors
$errWrongPass = "<span class='error'>Incorrect username or password entered, try again or <a href='index.php/register/'>register a new account</a>.</span>";
